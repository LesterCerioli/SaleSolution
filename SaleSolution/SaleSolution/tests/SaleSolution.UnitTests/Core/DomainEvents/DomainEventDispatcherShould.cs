using Autofac;
using SaleSolution.Core.Entities;
using SaleSolution.Core.Events;
using SaleSolution.Infrastructure;
using SaleSolution.Infrastructure.DomainEvents;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Logging.Abstractions;
using System;
using Xunit;

namespace SaleSolution.UnitTests.Core.DomainEvents
{
